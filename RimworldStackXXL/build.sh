...
mkdir -p "Resources/v1.1/Assemblies"
mkdir -p "Resources/v1.2/Assemblies"
mkdir -p "Resources/v1.3+/Assemblies"

# Copy the built assembly to all version folders
cp "bin/$BUILD_CONFIG/$PROJECT_NAME.dll" "Resources/v1.1/Assemblies/"
cp "bin/$BUILD_CONFIG/$PROJECT_NAME.dll" "Resources/v1.2/Assemblies/"
cp "bin/$BUILD_CONFIG/$PROJECT_NAME.dll" "Resources/v1.3+/Assemblies/"
...
echo "Assembly: bin/$BUILD_CONFIG/$PROJECT_NAME.dll"
echo "Mod ready: Resources/"
echo ""
